...
def test_facebook_login_with_cdp():
    """Test successful Facebook login flow with CDP Mode for enhanced stealth"""
    with SB(uc=True, headed=True) as sb:
        ...
        # Enter credentials (using test credentials from environment)
        sb.type('input[name="email"]', "test@example.com")
        sb.type('input[name="pass"]', "testpassword123")
...
def test_instagram_login_with_cdp():
    """Test successful Instagram login flow with CDP Mode for enhanced stealth"""
    with SB(uc=True, headed=True) as sb:
        # Activate CDP Mode for advanced anti-bot bypass
        ...
        # Enter credentials
        sb.type('input[name="username"]', "testuser")
        sb.type('input[name="password"]', "testpassword123")
...
def test_twitter_login_with_cdp():
    """Test successful Twitter/X login flow with CDP Mode for enhanced stealth"""
    with SB(uc=True, headed=True) as sb:
        # Activate CDP Mode for advanced anti-bot bypass
        ...
        # Enter username
        sb.type('input[autocomplete="username"]', "testuser")
...
def test_amazon_checkout_with_cdp():
    """Test Amazon checkout flow with CDP Mode for enhanced stealth"""
    with SB(uc=True, headed=True) as sb:
        # Activate CDP Mode for advanced anti-bot bypass
...
def test_shopify_checkout_with_cdp():
    """Test Shopify checkout flow with CDP Mode for enhanced stealth"""
    with SB(uc=True, headed=True) as sb:
        # Activate CDP Mode for advanced anti-bot bypass
